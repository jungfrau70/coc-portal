...
const API_URL = `${process.env.BASE_URL}/license`
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'vendor', value: 'vendor', width: '75', sortable: true },
        { text: 'license_type', value: 'license_type', width: '75', sortable: true },
        { text: 'status', value: 'status', width: '75', sortable: true },
        { text: 'instance_name', value: 'instance_name', width: '75', sortable: true },
        { text: 'installed_at', value: 'installed_at', width: '75', sortable: true },

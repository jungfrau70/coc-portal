...
def update(id:int,request:Schema, db:Session):
    ...
    db.query(Model).filter(Model.id == id).update({
        ...
        "cluster_name": reqeust.cluster_name,
        "node_type": reqeust.node_type,
        "node_name": reqeust.node_name,
        "node_ips": reqeust.node_ips,
        "api_vip": reqeust.api_vip,
        "flavor": reqeust.flavor,
        "network_zone": reqeust.network_zone,
        "contacts": reqeust.contacts,
        "k8s_version": reqeust.k8s_version,
        "monitoring_agent": reqeust.monitoring_agent,

        "api_cert_expired_date": reqeust.api_cert_expired_date,
        "ca_cert_expired_date": reqeust.ca_cert_expired_date,
        "etcd_cert_expired_date": reqeust.etcd_cert_expired_date,
